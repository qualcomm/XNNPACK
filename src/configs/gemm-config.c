...
static void init_bf16_f32_gemm_config(void) {
  ...
  if (XNN_ENABLE_AVX512BF16 && hardware_config->use_x86_avx512bf16) {
      ...
      bf16_f32_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(7)] = xnn_init_hmp_gemm_ukernel((xnn_gemm_ukernel_fn) xnn_bf16_f32_gemm_minmax_ukernel_7x32c2__asm_amd64_avx512bf16_broadcast);
...
static void init_pf32_gemm_config(void) {
  ...
  assert(hardware_config != NULL);
  (void) hardware_config;  // May be unused.
  if (XNN_ENABLE_ARM_SME && hardware_config->use_arm_sme) {
      ...
      pf32_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(mr)] =
          xnn_init_hmp_gemm_ukernel((
              xnn_gemm_ukernel_fn)xnn_pf32_gemm_minmax_ukernel_32x32__neonsme);
...
static void init_pqs8_qc8w_gemm_config(void) {
  ...
  if (XNN_ENABLE_ARM_SME && hardware_config->use_arm_sme) {
    ...
    pqs8_qc8w_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(mr)] =
        xnn_init_hmp_gemm_ukernel(
            (xnn_gemm_ukernel_fn)
                xnn_pqs8_qc8w_gemm_minmax_ukernel_32x32__neonsme);
	...
	pqs8_qc8w_gemm_config.is_sme1 = 1;
#endif  // XNN_ENABLE_ARM_SME
  }
    ...
    if (hardware_config->use_arm_neon) {
      ...
      f32_gemm_config.nr = 4;
        ...
        switch (cpuinfo_get_core(0)->uarch) {
		  ...
		  if(XNN_ENABLE_ARM_SME && hardware_config->use_arm_sme)
		  {
            f32_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(32)] = xnn_init_hmp_gemm_ukernel((xnn_gemm_ukernel_fn) xnn_pf32_gemm_minmax_ukernel_32x32__neonsme);
            f32_gemm_config.minmax.igemm[XNN_MR_TO_INDEX(32)] = xnn_init_hmp_igemm_ukernel((xnn_igemm_ukernel_fn) xnn_pf32_igemm_minmax_fp32_ukernel_32x32__neonsme);
            f32_gemm_config.pack_weights_and_biases = xnn_pack_kai_f32_weights_and_biases;
            f32_gemm_config.packed_stride_weights_and_biases = xnn_packed_stride_kai_f32_weights_and_biases;
            f32_gemm_config.init.f32 = xnn_init_f32_minmax_scalar_params;
			f32_gemm_config.pack_igemm_goki = (xnn_pack_conv_goki_w_fn)xnn_pack_kai_f32_conv_goki_w_sme;
            f32_gemm_config.mr = 32;
            f32_gemm_config.mr_packed = 32;
...
static void init_f32_gemm_nr2_config(void) {
    ...
    if (hardware_config->use_arm_neon) {
	  ...
	  {
   	    f32_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(32)] = xnn_init_hmp_gemm_ukernel((xnn_gemm_ukernel_fn) xnn_pf32_gemm_minmax_ukernel_32x32__neonsme);
   	    f32_gemm_nr2_config.minmax.igemm[XNN_MR_TO_INDEX(32)] = xnn_init_hmp_igemm_ukernel((xnn_igemm_ukernel_fn) xnn_pf32_igemm_minmax_fp32_ukernel_32x32__neonsme);
   	    f32_gemm_nr2_config.init.f32 = xnn_init_f32_minmax_scalar_params;
   	    f32_gemm_config.pack_weights_and_biases = xnn_pack_kai_f32_weights_and_biases;
   	    f32_gemm_config.packed_stride_weights_and_biases = xnn_packed_stride_kai_f32_weights_and_biases;
		f32_gemm_config.pack_igemm_goki = (xnn_pack_conv_goki_w_fn)xnn_pack_kai_f32_conv_goki_w_sme;
   	    f32_gemm_nr2_config.mr = 32;
   	    f32_gemm_nr2_config.mr_packed = 32;
...
static void init_qs8_qc8w_gemm_config(void) {
  ...
  qs8_qc8w_gemm_config.pack_gemm_goi = (xnn_packw_gemm_goi_ukernel_fn) xnn_pack_qs8_gemm_goi_w;
    ...
    (void) hardware_config;  // May be unused.
        ...
        if (XNN_ENABLE_ARM_SME && hardware_config->use_arm_sme) {
          #if XNN_ENABLE_ARM_SME
            const size_t mr = xnn_qs8_qc8w_igemm_minmax_fp32_ukernel_32x32__neonsme_get_mr();
            const size_t nr = xnn_qs8_qc8w_igemm_minmax_fp32_ukernel_32x32__neonsme_get_nr();
			qs8_qc8w_gemm_config.minmax.gemm[XNN_MR_TO_INDEX(mr)] =
				xnn_init_hmp_gemm_ukernel(
					(xnn_gemm_ukernel_fn)
						xnn_pqs8_qc8w_gemm_minmax_ukernel_32x32__neonsme);
            qs8_qc8w_gemm_config.minmax.igemm[XNN_MR_TO_INDEX(mr)] = xnn_init_hmp_igemm_ukernel((xnn_igemm_ukernel_fn) xnn_qs8_qc8w_igemm_minmax_fp32_ukernel_32x32__neonsme);
            qs8_qc8w_gemm_config.init.qs8_qc8w = xnn_init_qs8_qc8w_conv_minmax_fp32_neonv8_params;
            qs8_qc8w_gemm_config.pack_igemm_goki = (xnn_pack_conv_goki_w_fn) xnn_pack_kai_qs8_conv_goki_w_sme;
            qs8_qc8w_gemm_config.pack_igemm_kgo = (xnn_pack_conv_kgo_w_fn) xnn_pack_qs8_conv_kgo_w;
            qs8_qc8w_gemm_config.pack_deconv_goki = (xnn_pack_deconv_goki_w_fn) xnn_pack_qs8_deconv_goki_w;
            ...
            qs8_qc8w_gemm_config.packed_stride_weights_and_biases =
                xnn_packed_stride_kai_qs8_qc8w_weights_and_biases_sme2;
            qs8_qc8w_gemm_config.is_sme1 = 1;				
          #endif  // XNN_ENABLE_ARM_SME
        } 
