...
size_t xnn_qs8_qc8w_igemm_minmax_fp32_ukernel_32x32__neonsme_get_mr(void)
{
  return kai_get_mr_matmul_clamp_qai8_qai8p2vlx4_qsi8cxpsb2vlx4_2vlx2vl_sme1_mopa();
}

size_t xnn_qs8_qc8w_igemm_minmax_fp32_ukernel_32x32__neonsme_get_nr(void)
{
  return kai_get_nr_matmul_clamp_qai8_qai8p2vlx4_qsi8cxpsb2vlx4_2vlx2vl_sme1_mopa();
}

void xnn_qs8_qc8w_igemm_minmax_fp32_ukernel_32x32__neonsme(
  size_t mr,
  size_t nc,
  size_t kc,
  size_t ks,
...
{
  const size_t kai_mr = kai_get_mr_matmul_clamp_qai8_qai8p2vlx4_qsi8cxpsb2vlx4_2vlx2vl_sme1_mopa();
  ...
  kai_run_matmul_clamp_qai8_qai8p2vlx4_qsi8cxpsb2vlx4_2vlx2vl_sme1_mopa(
