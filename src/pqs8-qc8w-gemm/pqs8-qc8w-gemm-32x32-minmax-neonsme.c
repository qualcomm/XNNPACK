...
size_t xnn_pqs8_qc8w_gemm_minmax_ukernel_32x32__neonsme_get_mr() {
#if XNN_ENABLE_KLEIDIAI
...
size_t xnn_pqs8_qc8w_gemm_minmax_ukernel_32x32__neonsme_get_nr() {
#if XNN_ENABLE_KLEIDIAI
...
// Wraps the `kai_run_matmul_clamp_qai8_qai8p2vlx4_qsi8cxpsb2vlx4_2vlx2vl_sme1_mopa`
// GEMM microkernel with a name that is compatible with our tooling.
void xnn_pqs8_qc8w_gemm_minmax_ukernel_32x32__neonsme(
